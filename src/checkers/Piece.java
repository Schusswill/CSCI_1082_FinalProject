...
public class Piece{
	...
	//====================================================
		...
		// detects for potential winner every round	
			if (blackChipCounter == 9) {	// << Temp Condition
				System.out.println("Black is the WINNER!!");
			}
				else if (redChipCounter == 9) {
					System.out.println("Red is the WINNER!!");
				}
				else { // loop - next players turn
				}
